...
/**
 * Thinking 思考链组件（DeepSeek/OpenAI 风格）
 * 默认折叠，可展开查看模型的思考过程
 */
  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-2 w-full px-3 py-2 text-[12px] font-medium transition-colors hover:opacity-80"
        style={{ color: "var(--text-muted)" }}
      >
        {/* 思考图标：流式进行中显示动画点，停止后隐藏 */}
        {!isComplete && (
      ...
      {expanded && (
        <div
          className="px-3 pb-3 pt-1 text-[12px] leading-relaxed whitespace-pre-wrap"
          style={{
