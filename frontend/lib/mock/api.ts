...
const MOCK_RESPONSES: Record<string, string[]> = {
  help: [
    `<think>用户现在开启了一个新对话，我需要先介绍一下自己作为帮助说明智能体的功能。让我准备一个友好的欢迎信息，列出我可以演示的功能类型，并给出一些示例问题，这样用户就能快速上手体验系统了。</think>👋 **欢迎使用智能助手！**
...
> 📎 **点击下方附件可下载完整作业指导书PDF文件。**`,
    ...
    `<think>用户要求查看本月生产统计，我需要展示一个完整的生产报告示例，包含生产概况、产量数据表格、趋势分析、工作完成情况和下月计划。这是一个很好的展示数据表格和统计分析功能的机会，我会用多个表格来结构化展示不同类型的数据。</think>📈 **某平台本月生产统计分析**
...
> 📎 **完整溢油应急预案请下载附件《溢油应急响应手册》。`,
    ...
    `<think>用户询问如何使用智能助手，这是一个使用指南类型的内容。我需要介绍对话方法、功能特点、使用技巧和常见问题等，同时也是演示各种功能的好机会。我会用表格展示智能体类型和功能对比，用编号列表展示操作步骤，用常见问题的问答形式展示交互方式。</think>📚 **智能助手使用指南**
